---
name: "source-command-agent-memory-skill"
...
# source-command-agent-memory-skill

Use this skill when the user asks to run the migrated source command `agent-memory-SKILL`.
