---
name: "source-command-design-principles-skill"
...
# source-command-design-principles-skill

Use this skill when the user asks to run the migrated source command `design-principles-SKILL`.
